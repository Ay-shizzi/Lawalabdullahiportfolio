...
const PortfolioBox = (props) => {
  ...
  return (
    <>
      <a
        className="p-6 rounded-xl btn-shadow h-full w-full feature-box text-[#333] font-secondary flex flex-col items-center justify-center cursor-pointer"
      ...
      >
        ...
        >
          <div className="flex items-center justify-between w-full mt-5 mb-3">
            <small className="tracking-wider text-xm uppercase">
              {props.type}
            </small>
            <div className="flex items-center">
              <i className="cursor-pointer">
                <BiHeart className="transition mr-1" />
              </i>
          ...
          >
            <h2 className="text-2xl font-semibold leading-9 w-full cursor-pointer">
              {props.text}
              <FiArrowUpRight
                className={`${
