    ...
    >
      <div className="mb-10 lg:mb-0 sm:text-left text-center ">
        <div className="sticky top-56">
          <p className="tracking-widest lg:text-sm text-xs font-medium font-primary">
            Service Packages
          </p>
          <h1 className=" lg:text-5xl xl:text-6xl text-4xl font-secondary text-[#333] font-bold mt-3">
            My Services
          </h1>
        </div>
      </div>
